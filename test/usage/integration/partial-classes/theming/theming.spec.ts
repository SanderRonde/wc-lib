...
context('Theming', function() {
    ...
    propsSpec(
        getPartialClassFixture('theming', 'props'),
        getPartialClassFixture('theming', 'props-no-proxy'),
        false
    );
    themeManagerSpec(
        {
            standardFixture: getPartialClassFixture('theming', 'theme-manager'),
            invalidFixture: getPartialClassFixture(
                'theming',
                'theme-manager-invalid'
            ),
            separateFixture: getPartialClassFixture(
                'theming',
                'theme-manager-separate'
            ),
        },
        false
    );
