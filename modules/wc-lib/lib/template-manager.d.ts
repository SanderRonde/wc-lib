...
declare type ComplexValue = TemplateFnLike | Function | Object;
/**
...
export declare const WebComponentTemplateManagerMixin: <P extends Constructor<HTMLElement & Pick<WebComponentHierarchyManagerMixinInstance, "getParent"> & Partial<Pick<WebComponentListenableMixinInstance, "listen" | "clearListener">>>>(superFn: P) => {
    ...
    ```
        ...
        */
        ...
        getParent: <T extends any = {}>() => T | null;
        ...
        clearListener?: (<EV extends string | number>(event: EV, listener?: ((...args: import("./listener.js").EventListenerObj[EV]["args"]) => import("./listener.js").EventListenerObj[EV]["returnType"]) | undefined) => void) | undefined;
    };
    /**
