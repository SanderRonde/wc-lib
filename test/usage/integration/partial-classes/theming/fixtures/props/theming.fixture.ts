...
export class ObjEl extends ThemingWebComponent {
...
export class EmptyProps extends ThemingWebComponent {
	props = Props.define(this);
}
...
export class PrivProps extends ThemingWebComponent {
	props = Props.define(this, {
		priv:  {
			bool: {
				type: PROP_TYPE.BOOL,
...
export class ReflectProps extends ThemingWebComponent {
	props = Props.define(this, {
		reflect: {
			bool: {
				type: PROP_TYPE.BOOL,
...
const PropMixin = (superFn: typeof ThemingWebComponent) => class PropMixin extends superFn {
	props = Props.define(this, {
		reflect: {
			bool: {
				type: PROP_TYPE.BOOL,
...
export class InvalidDefineArg extends ThemingWebComponent {
	props = Props.define(this, {
		reflect: {
			mergedBool: {
				type: PROP_TYPE.BOOL,
...
export class WatchedComponent extends ThemingWebComponent {
	props = Props.define(this, {
		reflect: {
			watched: {
				type: ComplexType<DeepObject>(),
...
export class OverriddenProp extends ThemingWebComponent {
	bool: string = 'str';
...
export class NoReflectSelf extends ThemingWebComponent {
	props = Props.define(this, {
		reflect: {
			bool: {
				type: PROP_TYPE.BOOL,
