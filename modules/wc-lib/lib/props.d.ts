...
import { PROP_TYPE } from './enums.js';
/**
...
}, name: string, strict: boolean, type: 'string' | 'number' | 'bool' | ComplexTypeClass<any>): boolean | string | number | undefined | R;
...
export declare function getter<R>(element: HTMLElementAttributes & {
    getParentRef?(ref: string): any;
}, name: string, strict: boolean, type: ComplexTypeClass<any>): R | undefined;
/**
 ...
 * 	type of the value
 */
export declare function setter(setAttrFn: (key: string, val: string) => void, removeAttrFn: (key: string) => void, name: string, value: string | boolean | number, type: 'string' | 'number' | 'bool' | ComplexTypeClass<any>): void;
export declare function setter(setAttrFn: (key: string, val: string) => void, removeAttrFn: (key: string) => void, name: string, value: any, type: ComplexTypeClass<any>): void;
...
export declare type GetComplexTypeClassSpec<V> = V extends ComplexTypeClass<any, infer S> ? S : void;
declare type IsUnassigned<V extends PROP_TYPE | ComplexTypeClass<any> | DefinePropTypeConfig> = V extends PROP_TYPE.BOOL | PROP_TYPE.NUMBER | PROP_TYPE.STRING ? true : V extends ComplexTypeClass<any, any> ? GetComplexTypeClassSpec<V> extends 'optional' | 'unspecified' ? true : false : V extends PROP_TYPE.STRING_REQUIRED | PROP_TYPE.NUMBER_REQUIRED | PROP_TYPE.BOOL_REQUIRED ? false : V extends PROP_TYPE.STRING_OPTIONAL | PROP_TYPE.NUMBER_OPTIONAL | PROP_TYPE.BOOL_OPTIONAL ? true : V extends DefineTypeConfig ? V extends ExactTypeHaver ? V['exactType'] extends undefined | void ? true : false : V['type'] extends PROP_TYPE.STRING_REQUIRED | PROP_TYPE.NUMBER_REQUIRED | PROP_TYPE.BOOL_REQUIRED ? false : V['type'] extends ComplexTypeClass<any, any> ? GetComplexTypeClassSpec<V['type']> extends 'required' ? false : V['type'] extends PROP_TYPE.STRING_OPTIONAL | PROP_TYPE.NUMBER_OPTIONAL | PROP_TYPE.BOOL_OPTIONAL ? true : V['type'] extends ComplexTypeClass<any, any> ? GetComplexTypeClassSpec<V['type']> extends 'optional' ? true : V['type'] extends PROP_TYPE.BOOL | PROP_TYPE.NUMBER | PROP_TYPE.STRING | ComplexTypeClass<any> ? V extends OptionalConfig ? true : V extends PreDefined ? false : V extends Coerced ? false : true : false : V['type'] extends PROP_TYPE.BOOL | PROP_TYPE.NUMBER | PROP_TYPE.STRING | ComplexTypeClass<any> ? V extends OptionalConfig ? true : V extends PreDefined ? false : V extends Coerced ? false : true : false : V['type'] extends PROP_TYPE.STRING_OPTIONAL | PROP_TYPE.NUMBER_OPTIONAL | PROP_TYPE.BOOL_OPTIONAL ? true : V['type'] extends ComplexTypeClass<any, any> ? GetComplexTypeClassSpec<V['type']> extends 'optional' ? true : V['type'] extends PROP_TYPE.BOOL | PROP_TYPE.NUMBER | PROP_TYPE.STRING | ComplexTypeClass<any> ? V extends OptionalConfig ? true : V extends PreDefined ? false : V extends Coerced ? false : true : false : V['type'] extends PROP_TYPE.BOOL | PROP_TYPE.NUMBER | PROP_TYPE.STRING | ComplexTypeClass<any> ? V extends OptionalConfig ? true : V extends PreDefined ? false : V extends Coerced ? false : true : false : true;
/**
 * Gets the type of an individual property based on its config
 */
export declare type GetTSType<V extends PROP_TYPE | ComplexTypeClass<any> | DefinePropTypeConfig> = V extends PROP_TYPE.BOOL | PROP_TYPE.BOOL_OPTIONAL | PROP_TYPE.BOOL_REQUIRED ? boolean : V extends PROP_TYPE.NUMBER | PROP_TYPE.NUMBER_OPTIONAL | PROP_TYPE.NUMBER_REQUIRED ? number : V extends PROP_TYPE.STRING | PROP_TYPE.STRING_OPTIONAL | PROP_TYPE.STRING_REQUIRED ? string : V extends ComplexTypeClass<infer R> ? R : V extends DefineTypeConfig ? V extends ExactTypeHaver ? V['exactType'] : V['type'] extends PROP_TYPE.BOOL | PROP_TYPE.BOOL_OPTIONAL | PROP_TYPE.BOOL_REQUIRED ? V extends Coerced ? boolean : V extends PreDefined ? boolean : boolean : V['type'] extends PROP_TYPE.NUMBER | PROP_TYPE.NUMBER_OPTIONAL | PROP_TYPE.NUMBER_REQUIRED ? V extends Coerced ? number : V extends PreDefined ? number : number : V['type'] extends PROP_TYPE.STRING | PROP_TYPE.STRING_OPTIONAL | PROP_TYPE.STRING_REQUIRED ? V extends Coerced ? string : V extends PreDefined ? string : string : V['type'] extends ComplexTypeClass<infer R> ? V extends PreDefined ? R : R : void : void;
/**
 * A complex type for a property where the passed
 * template value is the actual type
 */
export declare type ComplexType<T> = ComplexTypeClass<any> & {
    __data: T;
};
export declare class ComplexTypeClass<_T, _R extends 'required' | 'optional' | 'unspecified' = 'unspecified'> {
 ...
 * 	complex types
 */
export declare function ComplexType<T>(): ComplexTypeClass<T>;
/**
 * A simple prop config that uses a type
 */
export declare type DefinePropTypes = PROP_TYPE | ComplexTypeClass<any>;
...
export declare function dashesToCasing(name: string): string;
/**
...
export declare class Props<C extends {
    ...
    static define<PUB extends PropConfigObject, PRIV extends PropConfigObject, R extends PropReturn<PUB, PRIV>>(element: PropComponent, config?: {}): Watchable<Props<typeof config>>;
    static define<PUB extends PropConfigObject, PRIV extends PropConfigObject, R extends PropReturn<PUB, PRIV>, PP extends PropReturn<any, any>>(element: PropComponent, config: {
        reflect: PUB;
        priv: PRIV;
    }, parentProps: PP): Watchable<Props<typeof config> & ReturnType<PUB, PRIV> & PP>;
    static define<PUB extends PropConfigObject, PRIV extends PropConfigObject, R extends PropReturn<PUB, PRIV>, PP extends PropReturn<any, any>>(element: PropComponent, config: {
        priv: PRIV;
    }, parentProps: PP): Watchable<Props<typeof config> & ReturnType<{}, PRIV> & PP>;
    static define<PUB extends PropConfigObject, PRIV extends PropConfigObject, R extends PropReturn<PUB, PRIV>, PP extends PropReturn<any, any>>(element: PropComponent, config: {
        reflect: PUB;
    }, parentProps: PP): Watchable<Props<typeof config> & ReturnType<PUB, {}> & PP>;
    static define<PUB extends PropConfigObject, PRIV extends PropConfigObject, R extends PropReturn<PUB, PRIV>, PP extends PropReturn<any, any>>(element: PropComponent, config: {}, parentProps: PP): Watchable<Props<typeof config> & PP>;
    /**
