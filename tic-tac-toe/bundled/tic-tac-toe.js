...
// tic-tac-toe/elements/cell-block/cell-block.html.js
var CellBlockHTML = new TemplateFn(function(html2, {props}) {
  return html2`
            <div
                id="cell"
                class="${{
    ["state-none"]: props.state === "",
    ["state-x"]: props.state === "X",
    ["state-o"]: props.state === "O"
  }}"
                @click="${this.onClick}"
            >
...
// tic-tac-toe/elements/cell-block/cell-block.css.js
...
// tic-tac-toe/elements/cell-block/cell-block.js
...
// tic-tac-toe/tic-tac-toe.html.js
...
// tic-tac-toe/tic-tac-toe.css.js
