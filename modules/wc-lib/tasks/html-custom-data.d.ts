...
export declare namespace HTMLCustomData {
    ...
    namespace GenerateCustomData {
        function _createInstance(tagName: string | null | undefined, baseClass: BaseClass): {
            ...
            renderToDOM(change?: number | undefined): void;
