 ...
 */
export class ConfigurableWebComponent<
    GA extends {
        i18n?: any;
        langs?: string;
...
> extends FullWebComponent<GA, E, ELS> {
    ...
    public get self(): typeof ConfigurableWebComponent {
        return null as any;
    }
    /**
 ...
 * with `@configure`.
 */
export declare class ConfiguredComponent<
    GA extends {
        i18n?: any;
        langs?: string;
        events?: EventListenerObj;
...
export function mixin<M1, MM1>(
    mixin1: MixinFn<DefaultClass, M1, MM1>
): M1 & {
    new (...args: any[]): MM1;
};
...
export function mixin<M1, MM1, M2, MM2, M3, MM3, M4, MM4, M5, MM5>(
    ...
    ClassToObj<M5> & {
        new (...args: any[]): Omit<
            MM1,
            keyof MM2 | keyof MM3 | keyof MM4 | keyof MM5
        > &
...
export function mixin<M1, MM1, M2, MM2, M3, MM3, M4, MM4, M5, MM5, M6, MM6>(
    ...
    ClassToObj<M1> & {
        new (...args: any[]): Omit<
            MM1,
            keyof MM2 | keyof MM3 | keyof MM4 | keyof MM5 | keyof MM6
        > &
...
>(
    ...
    ClassToObj<M1> & {
        ...
        > &
            Omit<
                MM2,
                keyof MM3 | keyof MM4 | keyof MM5 | keyof MM6 | keyof MM7
            > &
...
>(
    ...
    ClassToObj<M1> & {
        ...
        > &
            ...
            Omit<
                MM3,
                keyof MM4 | keyof MM5 | keyof MM6 | keyof MM7 | keyof MM8
            > &
...
>(
    ...
    ClassToObj<M1> & {
        ...
        > &
            ...
            Omit<
                MM4,
                keyof MM5 | keyof MM6 | keyof MM7 | keyof MM8 | keyof MM9
            > &
...
>(
    ...
    ClassToObj<M10> & {
        ...
        > &
            ...
            Omit<
                MM5,
                keyof MM6 | keyof MM7 | keyof MM8 | keyof MM9 | keyof MM10
            > &
