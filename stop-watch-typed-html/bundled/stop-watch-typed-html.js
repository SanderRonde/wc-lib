...
function config(config2) {
  const {is, html: html2, description, css = [], mixins = [], dependencies = []} = config2;
  return (target) => {
...
// stop-watch-typed-html/stop-watch-typed-html.html.js
var StopWatchTypedHTMLHTML = new TemplateFn(function(html2, {props}) {
  return html2`
            <h1 id="header">
...
// stop-watch-typed-html/stop-watch-typed-html.css.js
var StopWatchTypedHTMLCSS = new TemplateFn(function(html2) {
  return html2`
            <style>
                .inline {
...
// stop-watch-typed-html/stop-watch-typed-html.js
...
var TIMER_PRECISION = 10;
var StopWatchTypedHTML = class StopWatchTypedHTML2 extends ConfigurableWebComponent {
  constructor() {
    super(...arguments);
    this._timer = null;
    this._ms = 0;
  ...
  formatTime(ms) {
    return `${Math.round(ms / 1e3)}.${ms % 1e3 / TIMER_PRECISION}`;
  }
  onStart() {
    if (this._running)
      return;
...
StopWatchTypedHTML = __decorate5([
  config({
