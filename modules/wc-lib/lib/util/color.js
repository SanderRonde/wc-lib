...
(function (Color) {
    ...
    Color.getColorRepresentation = getColorRepresentation;
    /**
    ...
    Color.toStringColor = toStringColor;
    ...
    function changeOpacity(color, alpha) {
        ...
        return toStringColor(Object.assign(Object.assign({}, colorRepr), { a: alpha }));
    }
    Color.changeOpacity = changeOpacity;
    /**
     ...
     */
    function RGBToRGBA(color, alpha = 100) {
        return Object.assign(Object.assign({}, color), { a: alpha });
    }
     ...
     */
    function mergeColors(color1, color2, subtract = false) {
        ...
        return toStringColor({
            ...
            a: Math.max(Math.min(color1.a +
                color2.a, 100), 0),
        });
    }
    Color.mergeColors = mergeColors;
})(Color || (Color = {}));
