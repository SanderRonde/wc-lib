...
// stop-watch/stop-watch.html.js
var StopWatchHTML = new TemplateFn(function(html2, {props}) {
  return html2`
...
// stop-watch/stop-watch.css.js
var StopWatchCSS = new TemplateFn(function(html2) {
  return html2`
            <style>
                .inline {
...
var StopWatch = class StopWatch2 extends ConfigurableWebComponent {
  constructor() {
    super(...arguments);
    this._timer = null;
