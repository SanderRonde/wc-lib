 ...
 */
export declare type WebComponentThemeManagerMixinSuper = Constructor<Pick<WebComponentBaseMixinInstance, 'renderToDOM'> & Partial<Pick<WebComponentHierarchyManagerMixinInstance, 'globalProps' | 'listenGP'>>>;
/**
 ...
 */
export declare const WebComponentThemeManagerMixin: <P extends Constructor<Pick<WebComponentBaseMixinInstance, "renderToDOM"> & Partial<Pick<WebComponentHierarchyManagerMixinInstance, "globalProps" | "listenGP">>>>(superFn: P) => {
    new <GA extends {
        themes?: {
            [key: string]: any;
        } | undefined;
