...
import { assignAsGetter, bindToClass, } from './base.js';
...
class HierarchyClass {
    ...
    __subtreeChangeNotifyChildren() {
        this.__propagateDown((element) => {
            element.renderToDOM(8 /* SUBTREE_PROPS */);
    ...
    setGlobalProperty(key, value) {
        if (this.globalProperties[key] !== value) {
            ...
            this._self.renderToDOM(16 /* GLOBAL_PROPS */);
        }
    }
