import { TemplateFn, CHANGE_TYPE, config, Props, PROP_TYPE, bindToClass, Renderer } from '../../../../../../../build/es/wc-lib.js';
...
export class TestElementBase extends ComplexTemplatingWebComponent {
...
class NoCSS extends ComplexTemplatingWebComponent {
	static is = 'no-css';
...
export class BindTest extends ComplexTemplatingWebComponent {
	@bindToClass
	fn() {
		return this;
	}
...
window.WrongBindTest = (() => {
	...
	class WrongBindTest extends ComplexTemplatingWebComponent {
		@(bindToClass as any)
		fn: boolean = true;
	}
...
export class ChangeNever extends ComplexTemplatingWebComponent {
}
