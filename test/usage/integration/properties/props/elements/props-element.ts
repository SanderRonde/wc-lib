...
export function PropsElementFixtureFactory(
    ...
    @config({
        ...
        dependencies: [ObjEl as any, ChildEl as any],
    })
    class _PropsElement extends ConfigurableWebComponent {
        props = Props.define(this, {
            reflect: {
                ...
                watchAnyArr: {
                    type: ComplexType<
                        ((DeepObject & SymbolKeys) | null | undefined)[]
                    >(),
                    watchProperties: ['*'],
                    value: [
                        {
    ...
    const PropMixin = (superFn: typeof ConfigurableWebComponent) =>
        class PropMixin extends superFn {
            props = Props.define(this, {
                reflect: {
                    bool: {
                        type: PROP_TYPE.BOOL,
