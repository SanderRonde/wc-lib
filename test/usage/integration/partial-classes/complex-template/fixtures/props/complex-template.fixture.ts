...
export class ObjEl extends ComplexTemplatingWebComponent {
...
export class EmptyProps extends ComplexTemplatingWebComponent {
	props = Props.define(this);
}
...
export class PrivProps extends ComplexTemplatingWebComponent {
	props = Props.define(this, {
		priv:  {
			bool: {
				type: PROP_TYPE.BOOL,
...
const PropMixin = (superFn: typeof ComplexTemplatingWebComponent) => class PropMixin extends superFn {
	props = Props.define(this, {
		reflect: {
			bool: {
				type: PROP_TYPE.BOOL,
...
export class InvalidDefineArg extends ComplexTemplatingWebComponent {
	props = Props.define(this, {
		reflect: {
			mergedBool: {
				type: PROP_TYPE.BOOL,
...
export class OverriddenProp extends ComplexTemplatingWebComponent {
	bool: string = 'str';
...
export class NoReflectSelf extends ComplexTemplatingWebComponent {
	props = Props.define(this, {
		reflect: {
			bool: {
				type: PROP_TYPE.BOOL,
