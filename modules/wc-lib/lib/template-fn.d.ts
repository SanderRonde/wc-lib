...
import { Fragment, JSXDelayedExecutionCall } from './jsx-render.js';
import { WebComponent } from '../classes/full.js';
import { CHANGE_TYPE } from './enums.js';
export declare function createUniqueChangeType(): number;
/**
...
export declare type JSXTemplateFunction<R> = {
    <A extends {
        ...
        is: string;
    }), attrs: A | null, ...children: (R | any)[]): R | JSXDelayedExecutionCall;
};
/**
 ...
 */
params: ReturnType<C['getRenderArgs']>) => TR;
/**
 ...
 */
export declare class TemplateFn<C extends {
    getRenderArgs<CT extends CHANGE_TYPE | number>(changeType: CT): {};
} = WebComponent<any, any>, R extends TemplateRenderResult = TemplateRenderResult> implements TemplateFnLike {
    private _template;
    private _changeOn;
    private _renderer;
     ...
     */
    constructor(_template: TemplateRenderFunction<C, R> | null, changeOn: CHANGE_TYPE.NEVER, renderer: Renderer<R> | null);
    constructor(_template: TemplateRenderFunction<C, R>, changeOn: CHANGE_TYPE.ALWAYS | CHANGE_TYPE.PROP | CHANGE_TYPE.THEME | CHANGE_TYPE.LANG | number, renderer: Renderer<R> | null);
     ...
     */
    renderAsText(changeType: CHANGE_TYPE | number, component: C): string;
    /**
     ...
     */
    renderTemplate(changeType: CHANGE_TYPE | number, component: C): R | null;
    /**
     ...
     */
    renderSame<TR extends TemplateRenderResult>(changeType: CHANGE_TYPE | number, component: C, templater: JSXTemplater<TR | string>): TR | null | string;
    /**
