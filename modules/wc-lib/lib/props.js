...
function getNarrowedType(propType) {
    switch (propType) {
        case "string" /* STRING */:
        case "string_optional" /* STRING_OPTIONAL */:
        case "string_required" /* STRING_REQUIRED */:
            return "string" /* STRING */;
        case "bool" /* BOOL */:
        case "bool_optional" /* BOOL_OPTIONAL */:
        case "bool_required" /* BOOL_REQUIRED */:
            return "bool" /* BOOL */;
        case "number" /* NUMBER */:
        case "number_optional" /* NUMBER_OPTIONAL */:
        case "number_required" /* NUMBER_REQUIRED */:
...
(function (PropsDefiner) {
    ...
    function onSetAttribute(key, val, el) {
        ...
        if (el.keyMap.has(casingKey)) {
            ...
            if (watch) {
                queueRender(el, 1 /* PROP */, casingKey);
            }
        }
        else {
    ...
    function onRemoveAttribute(key, el) {
        ...
        if (el.keyMap.has(casingKey)) {
            ...
            const newVal = (() => {
                ...
                if (getNarrowedType(mapType) === "bool" /* BOOL */) {
                    return false;
                }
                return undefined;
            })();
        ...
        setPropAccessors() {
            ...
            Object.defineProperty(this._props, mapKey, {
                ...
                set(value) {
                    ...
                    if (watch) {
                        queueRender(_this._rep, 1 /* PROP */, mapKey);
                    }
                },
            });
        }
        assignComplexType() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this._rep.onConnect(mapKey, () => {
                    this._rep.propValues[mapKey] = Watching.watchValue(createQueueRenderFn(this._rep, mapKey), this._rep.component.hasAttribute(propName)
                        ? getter(this._rep.component, propName, strict, getNarrowedType(type))
...
export class Props {
    ...
    static define(element, config = {}, parentProps = element.props) {
        ...
        const { addListener } = PropsDefiner.define(props, element, config);
