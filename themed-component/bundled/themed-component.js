...
function config(config2) {
  const {is, html: html3, description, css: css2 = [], mixins = [], dependencies = []} = config2;
  return (target) => {
...
var html2 = (strings, ...values) => new TemplateResult(strings, values, "html", defaultTemplateProcessor);

// themed-component/themed-component.html.js
var ThemedComponentHTML = new TemplateFn(function() {
  return html2`
...
// themed-component/themed-component.css.js
var ThemedComponentCSS = new TemplateFn(function(html3, {theme}) {
  return html3`
            <style>
...
// themed-component/themed-component.js
...
var ThemedComponent = class ThemedComponent2 extends ConfigurableWebComponent {
  changeTheme(color) {
