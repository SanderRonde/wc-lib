...
export declare const FullWebComponent: {
    new <GA extends {
        ...
        disposables: (() => void)[];
        isMounted: boolean;
        readonly $: import("../lib/component.js").IDMapFn<ELS>;
        ...
        setLang: <L extends string = import("./types.js").DefaultValUnknown<GA["langs"], string>>(lang: L) => Promise<void>;
        getLang: () => string | import("./types.js").DefaultValUnknown<GA["langs"], string>;
        ...
        globalProps: <G extends GA["globalProps"] = {
            [key: string]: any;
        }>() => import("../wc-lib.all.js").GlobalPropsFunctions<import("./types.js").DefaultVal<G, {
            [key: string]: any;
        }>>;
        getRoot: <T extends GA["root"] = {}>() => T;
        getParent: <T extends GA["parent"] = {}>() => T | null;
        listenGP: import("../wc-lib.all.js").ListenGPType<GA>;
        ...
        ___definerClass: import("../wc-lib.all.js").DefinerClass;
        renderToDOM: (change?: import("../wc-lib.js").CHANGE_TYPE) => void;
    ...
    new (...args: any[]): {
        ...
        getAttribute: (qualifiedName: string) => string | null;
        renderToDOM: (change?: import("../wc-lib.js").CHANGE_TYPE) => void;
        getParentRef: (ref: string) => Object | Function | import("../wc-lib.js").TemplateFnLike<number>;
    };
} & {
    new (...args: any[]): {
        generateHTMLTemplate(strings: TemplateStringsArray, ...values: any[]): import("../wc-lib.js").TemplateResultLike;
        getRef(ref: string): Object | Function | import("../wc-lib.js").TemplateFnLike<number>;
        getParentRef(ref: string): Object | Function | import("../wc-lib.js").TemplateFnLike<number>;
        genRef(value: Object | Function | import("../wc-lib.js").TemplateFnLike<number>): string;
        accessKey: string;
        readonly accessKeyLabel: string;
        autocapitalize: string;
        dir: string;
        ...
        listen?: (<EV extends string | number>(event: EV, listener: (...args: EventListenerObj[EV]["args"]) => EventListenerObj[EV]["returnType"], once?: boolean) => void) | undefined;
        clearListener?: (<EV extends string | number>(event: EV, listener?: ((...args: EventListenerObj[EV]["args"]) => EventListenerObj[EV]["returnType"]) | undefined) => void) | undefined;
    };
    initComplexTemplateProvider(config: import("../wc-lib.js").LitHTMLConfig): void;
} & {
    new <GA extends {
        i18n?: any;
        langs?: string | undefined;
        ...
        setLang<L extends import("./types.js").DefaultValUnknown<GA["langs"], string>>(lang: L): Promise<void>;
        getLang(): string | import("./types.js").DefaultValUnknown<GA["langs"], string>;
        __prom<I extends GA["i18n"] = {
            [key: string]: any;
        }>(key: Extract<keyof I, string>, ...values: any[]): Promise<string>;
