...
class NoCSS extends ThemingWebComponent {
	static is = 'no-css';
...
export class BindTest extends ThemingWebComponent {
	@bindToClass
	fn() {
		return this;
	}
...
window.WrongBindTest = (() => {
	...
	class WrongBindTest extends ThemingWebComponent {
		@(bindToClass as any)
		fn: boolean = true;
	}
...
export class ChangeNever extends ThemingWebComponent {
}
...
export class HTMLElementTemplate extends ThemingWebComponent {
}
