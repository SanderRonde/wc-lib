...
(function (NARROWED_PROP_TYPE) {
    /**
     * A string
     */
    NARROWED_PROP_TYPE["STRING"] = "string";
    /**
     * A number
     */
    NARROWED_PROP_TYPE["NUMBER"] = "number";
    /**
     * A boolean
     */
    NARROWED_PROP_TYPE["BOOL"] = "bool";
...
export function dashesToCasing(name) {
...
(function (PropsDefiner) {
    ...
    function joinProps(previousProps, config) {
        ...
        for (const key of ['reflect', 'priv']) {
            /* istanbul ignore next */
            if (((_a = previousProps.__config) === null || _a === void 0 ? void 0 : _a[key]) || config[key]) {
                joinedConfig[key] = Object.assign(Object.assign({}, (_b = previousProps.__config) === null || _b === void 0 ? void 0 : _b[key]), config[key]);
            }
        }
