        ...
        (function (TextToTags) {
            ...
            (function (_CSS) {
                class CSSTag extends TextToTags.Tag {
                    ...
                    get elementGlobal() {
                        return (this._changeOn === CHANGE_TYPE.THEME ||
                ...
                function _parseElementCSS(element, instance) {
                    ...
                    return templates.map((template) => {
                        const text = _tryRender(() => {
                            return (
                            /* istanbul ignore next */
                            (template === null || template === void 0 ? void 0 : template.renderAsText(CHANGE_TYPE.ALWAYS, instance)) || '');
                        });
                ...
                function renderToText(instance, template, session) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const renderedTemplate = _tryRender(() => {
                            return template.renderTemplate(CHANGE_TYPE.ALWAYS, instance);
                        });
                        if (typeof renderedTemplate !== 'object' ||
                            !('values' in renderedTemplate) ||
                            !('strings' in renderedTemplate)) {
                            return {
                                str: template.renderAsText(CHANGE_TYPE.ALWAYS, instance),
                                markers: [],
                            };
                        }
