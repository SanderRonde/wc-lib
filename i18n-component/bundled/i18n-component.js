...
function config(config2) {
  const {is, html: html3, description, css = [], mixins = [], dependencies = []} = config2;
  return (target) => {
...
// i18n-component/i18n-component.html.js
var I18nComponentHTML = new TemplateFn(function() {
  return html2`
...
// i18n-component/i18n-component.js
...
var I18nComponent = class I18nComponent2 extends ConfigurableWebComponent {
};
I18nComponent = __decorate5([
  config({
    is: "i18n-component",
    css: new TemplateFn((html3) => {
      return html3`
                <style>
                    button,
                    #input {
