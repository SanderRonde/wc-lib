...
context('Complex Template', function() {
    ...
    propsSpec(
        getPartialClassFixture('complex-template', 'props'),
        getPartialClassFixture('complex-template', 'props-no-proxy'),
        false
    );
    ...
    templateManagerSpec({
        standard: getPartialClassFixture(
            'complex-template',
            'template-manager'
        ),
        wrong: getPartialClassFixture(
            'complex-template',
            'template-manager-wrong'
        ),
    });
});
