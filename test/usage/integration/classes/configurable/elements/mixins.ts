...
const MixinA = (
    superFn: typeof ConfigurableWebComponent & {
...
const MixinB = (superFn: MixinReturn<typeof MixinA>) =>
    class MixinB extends superFn {
        b = 1;
    };
const MixinC = (superFn: MixinReturn<typeof MixinB>) =>
    class MixinC extends superFn {
        c = 1;
    };
const MixinD = (superFn: MixinReturn<typeof MixinC>) =>
    class MixinD extends superFn {
        d = 1;
    };
const MixinE = (superFn: MixinReturn<typeof MixinD>) =>
    class MixinE extends superFn {
        e = 1;
    };
const MixinZ = <S extends Constructor<{}>>(superFn: S) =>
    class MixinZ extends superFn {
        z = 1;
    };
...
export class MultiMixin extends mixin(
    ConfigurableMixin,
    MixinA,
    MixinB,
    MixinC,
